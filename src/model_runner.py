...
from utils.helpers import (
    load_config, get_age_group, format_prompt_with_history,
    log_operation_status
)
from src.history import StoryHistoryManager
from src.eval import evaluate_single_text, load_evaluation_models
...
class StoryModelRunner:
    ...
    def interactive_story_session(self):
        """Run interactive story generation session."""
    ...
    def _create_new_story(self, user_info: Dict[str, Any]):
        ...
        if result['success']:
            ...
            print(
                f"  Quality Scores: Grammar {evaluation['grammar_score']:.1f}/100, Coherence {evaluation['coherence_score']:.1f}/100")
